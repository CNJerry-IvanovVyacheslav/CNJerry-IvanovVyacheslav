...
На данный момент имею в своем портфолио 5 законченных приложения и 1 проект в разработке:
...
- [Not for Goblins](https://github.com/CNJerry-IvanovVyacheslav/Not_for_Goblins) - 2D Tower Defense для Android с элементами Roguelite.
```
val aboutMe = object {
